...
local function ts_select(lhs, capture, desc)
    map(
        { 'x', 'o' },
        lhs,
...
local function ts_move(lhs, method, capture, desc)
    map(
        { 'n', 'x', 'o' },
        lhs,
...
ts_select('ai', '@block.outer', 'Around code block')
ts_select('ii', '@block.inner', 'Inside code block')
ts_select('af', '@function.outer', 'Around function')
ts_select('if', '@function.inner', 'Inside function')
ts_select('ac', '@class.outer', 'Around class')
ts_select('ic', '@class.inner', 'Inside class')
ts_select('aC', '@conditional.outer', 'Around conditional')
ts_select('iC', '@conditional.inner', 'Inside conditional')
ts_select('al', '@loop.outer', 'Around loop')
ts_select('il', '@loop.inner', 'Inside loop')
ts_select('aa', '@parameter.outer', 'Around argument')
ts_select('ia', '@parameter.inner', 'Inside argument')
ts_select('aF', '@call.outer', 'Around function call')
ts_select('iF', '@call.inner', 'Inside function call')

ts_move(']f', 'goto_next_start', '@function.outer', 'Next function start')
ts_move('[f', 'goto_previous_start', '@function.outer', 'Previous function start')
ts_move(']F', 'goto_next_end', '@function.outer', 'Next function end')
ts_move('[F', 'goto_previous_end', '@function.outer', 'Previous function end')
ts_move(']C', 'goto_next_start', '@class.outer', 'Next class')
ts_move('[C', 'goto_previous_start', '@class.outer', 'Previous class')
...
-- ── 42 School ────────────────────────────────────────────────────────
map('n', '<leader>42', '<CMD>Stdheader<CR>', { desc = '42 header' })
